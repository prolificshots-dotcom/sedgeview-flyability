...
def get_forecast(lat, lon):
    url = "https://open-meteo.com{lat}&longitude={lon}&hourly=temperature_2m,rain,wind_speed_10m,wind_gusts_10m,wind_direction_10m&wind_speed_unit=kmh&forecast_days=2"
